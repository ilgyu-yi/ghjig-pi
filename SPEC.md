...
| Section | Title | Line |
|---|---|---|
| §0 | Intent and scope | 63 |
| &nbsp;&nbsp;§0.1 | What the SPEC governs | 67 |
| &nbsp;&nbsp;§0.2 | Relation to MISSION | 71 |
| &nbsp;&nbsp;§0.3 | Reading and amendment conventions | 75 |
| §1 | Work norms | 79 |
| &nbsp;&nbsp;§1.1 | The standard flow | 83 |
| &nbsp;&nbsp;§1.2 | Doc → Test → Code work order | 95 |
| &nbsp;&nbsp;§1.3 | Changelog-fragment discipline | 111 |
| &nbsp;&nbsp;§1.4 | Review escalation | 115 |
| &nbsp;&nbsp;§1.5 | Delegated work | 127 |
| &nbsp;&nbsp;§1.6 | Review integrity | 139 |
| &nbsp;&nbsp;§1.7 | High-asymmetry quorum | 151 |
| &nbsp;&nbsp;§1.8 | Plan contest | 161 |
| &nbsp;&nbsp;§1.9 | Finding judgment | 173 |
| §2 | Artifact hierarchy and lifecycle | 185 |
| &nbsp;&nbsp;§2.1 | Issue types | 189 |
| &nbsp;&nbsp;§2.2 | Lifecycle states | 202 |
| &nbsp;&nbsp;§2.3 | PR-as-living-doc | 218 |
| &nbsp;&nbsp;§2.4 | Evidence discipline | 222 |
| &nbsp;&nbsp;§2.5 | Authoring doctrine | 237 |
| &nbsp;&nbsp;§2.6 | SSOT change-reach protocol | 258 |
| &nbsp;&nbsp;§2.7 | Canonical naming | 270 |
| &nbsp;&nbsp;§2.8 | Artifact surfaces | 280 |
| §3 | Enforcement-layer architecture | 292 |
| &nbsp;&nbsp;§3.1 | The constraint | 296 |
| &nbsp;&nbsp;§3.2 | The three tiers | 303 |
| &nbsp;&nbsp;§3.3 | Gate classes | 311 |
| &nbsp;&nbsp;§3.4 | Agent-agnosticism of the tiers | 332 |
| &nbsp;&nbsp;§3.5 | Gate conduct | 336 |
| &nbsp;&nbsp;§3.6 | Enforcement-face selection | 340 |
| &nbsp;&nbsp;§3.7 | Approval-gate completeness | 350 |
| &nbsp;&nbsp;§3.8 | Escape architecture | 362 |
| &nbsp;&nbsp;§3.9 | Fail policy | 373 |
| &nbsp;&nbsp;§3.10 | Delegated computation | 383 |
| &nbsp;&nbsp;§3.11 | Gate design | 393 |
| &nbsp;&nbsp;§3.12 | Gate verification | 415 |
| §4 | Substrate and install contract | 425 |
| &nbsp;&nbsp;§4.1 | Namespaces | 429 |
| &nbsp;&nbsp;§4.2 | Target-parameterization | 433 |
| &nbsp;&nbsp;§4.3 | PR-based installs | 437 |
| &nbsp;&nbsp;§4.4 | Headless and scripted operation | 441 |
| &nbsp;&nbsp;§4.5 | Installed-asset freshness | 445 |
| §5 | Cross-cutting contracts | 451 |
| &nbsp;&nbsp;§5.1 | Self-contained artifacts | 455 |
| &nbsp;&nbsp;§5.2 | Graceful degradation | 459 |
| &nbsp;&nbsp;§5.3 | Gate-activation conditions | 463 |
| &nbsp;&nbsp;§5.4 | Work language | 467 |
| &nbsp;&nbsp;§5.5 | State boundary | 471 |
| &nbsp;&nbsp;§5.6 | Operating modes | 477 |
| &nbsp;&nbsp;§5.7 | Unattended conduct | 487 |
| §6 | Self-governance milestone | 497 |
<!-- TOC END -->
...
This section states the standard flow every change rides — issue → branch → draft PR → review-gated merge — the Doc → Test → Code work order with its strict and relaxed conditions, its pre-1.0 Doc-loop macro-phase, the per-PR changelog-fragment discipline, the review-escalation ladder for repeated rejection (§1.4), and the delegation-and-review architecture: delegated work (§1.5), review integrity (§1.6), the high-asymmetry quorum (§1.7), the plan contest (§1.8), and finding judgment (§1.9).
...
This section states how shell assets install into a repository: target-parameterized, homed in shell-owned namespaces that collide with no other tooling's, landed through PR-based installs — and kept observably fresh after landing (§4.5).
...
Remedy text distinguishes the two gap shapes: one a session restart fixes (the shell itself gained the asset mid-session, so the running session is behind its own tree) and one only a re-install fixes (the target's installed set predates the asset). A wrong prescribed remedy at the failure site is itself a defect this section exists to prevent. The norm is **explicitly advisory** (§3.1 rule 1): a freshness advisory, never a block.

## 5. Cross-cutting contracts

This section states the contracts that bind every section: self-contained artifacts, graceful degradation for best-effort automations, explicit activation conditions for gates that sleep until their subject exists, the state boundary shell-written state honors (§5.5), the operating modes that set the autonomy ceiling (§5.6), and the conduct an unattended run owes (§5.7).
