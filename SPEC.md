...
| commit-format | malformed commit subjects | `home:` tier 2 (adapter committed, its delegated grammar check not shipped here yet) · `backstop:` none (reversible) · `earlier:` — | `supplies:` git (message file) / `infers:` session |
