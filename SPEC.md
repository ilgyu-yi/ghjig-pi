...
| Section | Title | Line |
|---|---|---|
| §0 | Intent and scope | 50 |
| &nbsp;&nbsp;§0.1 | What the SPEC governs | 54 |
| &nbsp;&nbsp;§0.2 | Relation to MISSION | 58 |
| &nbsp;&nbsp;§0.3 | Reading and amendment conventions | 62 |
| §1 | Work norms | 66 |
| &nbsp;&nbsp;§1.1 | The standard flow | 70 |
| &nbsp;&nbsp;§1.2 | Doc → Test → Code work order | 81 |
| &nbsp;&nbsp;§1.3 | Changelog-fragment discipline | 93 |
| &nbsp;&nbsp;§1.4 | Review escalation | 97 |
| §2 | Artifact hierarchy and lifecycle | 109 |
| &nbsp;&nbsp;§2.1 | Issue types | 113 |
| &nbsp;&nbsp;§2.2 | Lifecycle states | 124 |
| &nbsp;&nbsp;§2.3 | PR-as-living-doc | 134 |
| &nbsp;&nbsp;§2.4 | Evidence discipline | 138 |
| &nbsp;&nbsp;§2.5 | Authoring doctrine | 150 |
| &nbsp;&nbsp;§2.6 | SSOT change-reach protocol | 171 |
| &nbsp;&nbsp;§2.7 | Canonical naming | 181 |
| §3 | Enforcement-layer architecture | 189 |
| &nbsp;&nbsp;§3.1 | The constraint | 193 |
| &nbsp;&nbsp;§3.2 | The three tiers | 200 |
| &nbsp;&nbsp;§3.3 | Gate classes | 208 |
| &nbsp;&nbsp;§3.4 | Agent-agnosticism of the tiers | 229 |
| &nbsp;&nbsp;§3.5 | Gate conduct | 233 |
| &nbsp;&nbsp;§3.6 | Enforcement-face selection | 237 |
| &nbsp;&nbsp;§3.7 | Approval-gate completeness | 247 |
| §4 | Substrate and install contract | 259 |
| &nbsp;&nbsp;§4.1 | Namespaces | 263 |
| &nbsp;&nbsp;§4.2 | Target-parameterization | 267 |
| &nbsp;&nbsp;§4.3 | PR-based installs | 271 |
| &nbsp;&nbsp;§4.4 | Headless and scripted operation | 275 |
| &nbsp;&nbsp;§4.5 | Installed-asset freshness | 279 |
| §5 | Cross-cutting contracts | 285 |
| &nbsp;&nbsp;§5.1 | Self-contained artifacts | 289 |
| &nbsp;&nbsp;§5.2 | Graceful degradation | 293 |
| &nbsp;&nbsp;§5.3 | Gate-activation conditions | 297 |
| &nbsp;&nbsp;§5.4 | Work language | 301 |
| &nbsp;&nbsp;§5.5 | State boundary | 305 |
| §6 | Self-governance milestone | 311 |
<!-- TOC END -->
...
This section states the standard flow every change rides — issue → branch → draft PR → review-gated merge — the Doc → Test → Code work order with its strict and relaxed conditions, its pre-1.0 Doc-loop macro-phase, the per-PR changelog-fragment discipline, and the review-escalation ladder for repeated rejection (§1.4).
...
- (d) **Evidence provenance** — a passing verdict artifact derives only from a real reviewer run and is never hand-authored; where hand-forgery remains technically possible, the surfaces that would detect it are retained, so a deferred hardening stays measurable rather than blind.
